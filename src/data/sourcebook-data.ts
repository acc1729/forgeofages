...
import { FeatData } from './feat-data';
...
export class SourcebookData {
	static core: Sourcebook = {
		id: '',
		name: 'Core',
		description: 'The core 13th Age book.',
		isHomebrew: false,
		ancestries: [
			AncestryData.human,
			AncestryData.dwarf,
		...
		domains: [],
		feats: [
			FeatData.improvedInitiative,
			FeatData.linguistAdv,
			FeatData.linguistCha,
			FeatData.preciseShot,
		],
		kits: [
